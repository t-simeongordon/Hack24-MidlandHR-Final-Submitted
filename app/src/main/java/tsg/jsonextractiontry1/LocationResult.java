...
public class LocationResult extends AppCompatActivity {
...
//                tv.setText("");
        urlString = "https://zymb.eu/api/v1/employee/location/";

        if(s1!=null) {
            urlString = "https://zymb.eu/api/v1/employee/location/"+s1;
...
//        });
    ...
    private class ProcessJSON extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(LocationResult.this);
...
//                        data += "year= "+ year1 +" \n Name= "+ name +" \n ";
                    ...
                    adapter = new MainListViewAdapter(LocationResult.this,
                            organisationProList);
