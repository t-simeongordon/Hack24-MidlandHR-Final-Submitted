...
//                tv.setText("");
                urlString = "https://zymb.eu/api/v1/";

        if(s1!=null) {
            urlString = "https://zymb.eu/api/v1/"+s1;
...
//                        String name = jsonObject.optString("first_name").toString();
                        ...
                        map.setSkill(jsonObject.optString("job_title").toString());
...
//                        data += "year= "+ year1 +" \n Name= "+ name +" \n ";
                    ...
                    adapter = new MainListViewAdapter(MainActivity.this,
                            organisationProList);
